            ...
            return (
              <Card key={s.id} className="transition-shadow hover:shadow-md">
                ...
                <CardContent className="space-y-2">
                  {s.phone && <div className="flex items-center gap-2 text-sm text-muted-foreground"><Phone className="h-3.5 w-3.5 shrink-0" />{s.phone}</div>}
                  {s.email && <div className="flex items-center gap-2 text-sm text-muted-foreground"><Mail className="h-3.5 w-3.5 shrink-0" />{s.email}</div>}
                  {s.area && (
                  ...
                  <div className="border-t pt-2.5 mt-1">
                    ...
                    <p className="font-bold text-primary text-sm">{formatCurrency(Number(s.totalSales ?? 0))}</p>
                  </div>
                </CardContent>
              </Card>
            );
