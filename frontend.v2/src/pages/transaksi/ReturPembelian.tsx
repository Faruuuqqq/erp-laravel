  ...
  const addItem = () => {
    ...
    if (existingIdx >= 0) {
      ...
      setItems([...items, {
        ...
        nama: product.name,
        qty: qtyNum,
        harga: product.buyPrice,
        satuan: product.unit,
        subtotal: product.buyPrice * qtyNum,
      }]);
    }
          ...
          <Card className="sticky top-20">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="tabular-nums">{items.reduce((s, i) => s + i.qty, 0)} pcs</span>
              </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Retur sebesar <strong>{formatRupiah(totalNilai)}</strong> akan mengurangi stok dan utang ke supplier.
