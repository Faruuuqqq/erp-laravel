...
const HistoriPembayaranPiutang = () => {
  ...
  const handleExportXlsx = useCallback(async () => {
    ...
    try {
      const headers = ['No. Kwitansi', 'Tanggal', 'Customer', 'Jumlah Diterima', 'Catatan'];
      ...
      await exportTransactionsToXlsx({
        filename: getFilenameWithDate('histori-pembayaran-piutang'),
        headers,
        data,
        currencyColumns: [3],
        rightAlignColumns: [3],
             ...
             <Table>
               ...
               <TableBody>
                 {isLoading ? (
                   ...
                   <TableRow><TableCell colSpan={7} className="text-center py-10 text-muted-foreground">Tidak ada data pembayaran piutang</TableCell></TableRow>
                 ) : filtered.map(t => (
