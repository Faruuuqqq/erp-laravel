...
import { Search, Receipt, Wallet, CheckCircle2 } from 'lucide-react';
import { Badge } from '@/components/ui/badge';
import { useState } from 'react';
import { useHistoryPembayaranPiutang } from '@/hooks/api/useReports';
...
const HistoriPembayaranPiutang = () => {
  ...
  const { data, isLoading, error } = useHistoryPembayaranPiutang({
    from: fromDate,
    to: toDate,
    page,
    perPage,
  ...
  return (
    <MainLayout
      ...
      subtitle="Daftar pembayaran pelanggan"
    >
      <div className="mb-6 flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2">
          <ExportButton
            data={payments}
            filename={`pembayaran_piutang_${formatDateRange(fromDate, toDate)}`}
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Total Diterima (Halaman)</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Daftar Pembayaran Piutang</CardTitle>
        </CardHeader>
        <CardContent className="p-0">
          <VirtualTable
            ...
            isLoading={isLoading}
            error={error}
            emptyMessage="Tidak ada data pembayaran piutang"
          >
            {meta && (
              <Pagination
