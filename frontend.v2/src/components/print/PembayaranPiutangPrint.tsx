...
interface PembayaranPiutangPrintProps {
  transaction: Transaction;
}

export const PembayaranPiutangPrint = ({ transaction }: PembayaranPiutangPrintProps) => {
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-8 text-sm">
          <div>
            ...
            <p className="text-lg font-bold">{transaction.customer || 'N/A'}</p>
          </div>
        ...
        <div className="space-y-4">
          <h3 className="font-bold uppercase text-sm">Detail Penerimaan Pembayaran</h3>
          
          <div className="bg-gray-50 p-4 rounded space-y-3">
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">Jumlah Diterima:</span>
        ...
        {transaction.items && transaction.items.length > 0 && (
          <div className="space-y-2">
            <p className="text-xs font-semibold text-gray-600 uppercase">Rincian Pelunasan Piutang</p>
        ...
        <div className="text-xs text-gray-500 italic pt-4">
          Dokumen ini merupakan bukti resmi penerimaan pembayaran. Mohon disimpan dengan baik.
        </div>
      </div>
    </PrintLayout>
  );
...
export default PembayaranPiutangPrint;
