...
/**
 * Retur Penjualan (Sales Return) Formal Template
 */
export const ReturPenjualanTemplate = ({
  data,
  ...
  return (
    <div className="retur-penjualan-template">
      {/* HEADER */}
      ...
      <div className="document-meta mb-4">
        ...
        <div className="meta-item">
          ...
          <span className="meta-value">{data.notes ? 'Lihat Catatan' : '-'}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4 text-sm avoid-break">
        ...
        <div className="p-2 border border-gray-200 rounded">
          ...
          <p className="text-xs mb-1">
            <span className="font-semibold">Jenis:</span> Retur Penjualan
          </p>
          <p className="text-xs">
      ...
      <div className="summary-section mb-4 avoid-break">
        ...
        <div>
          ...
          <div className="summary-item mt-2 pt-2 border-t-2 border-black">
            <span className="text-xs font-bold uppercase">Total Pengembalian Dana:</span>
            <span className="summary-value currency text-lg font-bold">
      ...
      <div className="document-footer">
        <div className="signature-section">
          ...
          <div className="signature-block">
            <p className="text-xs font-semibold mb-1">Diterima Oleh</p>
            <div className="signature-line"></div>
...
export default ReturPenjualanTemplate;
